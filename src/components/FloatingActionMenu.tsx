  ...
  return (
    <div className="fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-40 flex flex-col items-end gap-3 pointer-events-none">
        ...
        <div className="flex flex-col items-end gap-2.5 mb-2 pointer-events-auto animate-fade-in">
          ...
          <div className="flex items-center gap-2.5 group">
            ...
            <motion.button
              ...
              className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 text-white shadow-xl shadow-indigo-600/30 flex items-center justify-center transition-all cursor-pointer border border-indigo-400/40"
          ...
          <div className="flex items-center gap-2.5 group">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              transition={{ type: 'spring', stiffness: 260, damping: 20 }}
              className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-white shadow-xl shadow-amber-600/30 flex items-center justify-center transition-all cursor-pointer border border-amber-400/40"
          ...
          <div className="flex items-center gap-2.5 group">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              transition={{ type: 'spring', stiffness: 260, damping: 20 }}
              className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white shadow-xl shadow-emerald-600/30 flex items-center justify-center transition-all cursor-pointer border border-emerald-400/40"
          ...
          <div className="flex items-center gap-2.5 group">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              transition={{ type: 'spring', stiffness: 260, damping: 20 }}
              className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 text-white shadow-xl shadow-purple-600/30 flex items-center justify-center transition-all cursor-pointer border border-purple-400/40"
          ...
          <div className="flex items-center gap-2.5 group">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              transition={{ type: 'spring', stiffness: 260, damping: 20 }}
              className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-slate-800 to-slate-700 hover:from-slate-700 hover:to-slate-600 text-white shadow-xl shadow-slate-900/40 flex items-center justify-center transition-all cursor-pointer border border-slate-600/40"
      ...
      <motion.button
        ...
        className={`w-14 h-14 rounded-3xl text-white shadow-2xl flex items-center justify-center transition-all transform cursor-pointer pointer-events-auto relative border ${
          isOpen
